...
TEST(TestArgParse, TestValidInputs) {
    ...
    const char *argv0[] = {"aoc2024", "-d", "1", "-p", "1", "-f", "../../resources/day01.txt"};
    ...
    const char *argv1[] = {
        "aoc2024", "-p", "2", "-f", "../../resources/day01.txt", "-d", "25"};
...
TEST(TestArgParse, TestInvalidInputs) {
    aoc::ArgParse parser0{};
    const char *argv0[] = {
        "aoc2024", "-d", "26", "-p", "1", "-f", "../../resources/day01.txt"};
    auto stat = parser0.parseArgs(7, argv0);
...
TEST(TestArgParse, TestIncomplete) {
    aoc::ArgParse parser0{};
    const char *argv0[] = {"aoc2024", "-d", "4", "-f", "../../resources/day01.txt"};
    ...
    aoc::ArgParse parser2{};
    const char *argv2[] = {"aoc2024", "-p", "1", "-f", "../../resources/day01.txt"};
...
TEST(TestArgParse, TestMultiple) {
    aoc::ArgParse parser0{};
    const char *argv0[] = {
        "aoc2024", "-f", "../../resources/day01.txt", "-f", "../../resources/day01.txt"};
    auto stat = parser0.parseArgs(5, argv0);
    ASSERT_EQ(stat, aoc::ArgParse::Status::FAIL);
